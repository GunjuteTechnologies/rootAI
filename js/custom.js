...
POTENZA.rangesliders = function () {
  ...
  *************************/
  ...
  /*************************
    Gsap
  *************************/
  gsap.set('.awards-wrapper img.gsap-img-animation, .case-studies-wrapper img.gsap-img-animation', { yPercent: -50, xPercent: -50 });
  let activeImage;
  gsap.utils.toArray(".awards-item, .case-studies-item").forEach((el) => {
